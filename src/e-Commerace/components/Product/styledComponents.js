...
const ProductDetails=styled.div`${tw`w-48 border border-solid border-bg-gray-300 flex flex-col justify-center ml-12 mb-10 p-2 relative`}`
const ProductTitle=styled.p`${tw`h-45px m-0 text-center`}`
const ProductStyleLine=styled.p`${tw`w-4 ml-20 border-t-2 rounded border-yellow-600 mt-2 px mb-2`}`
